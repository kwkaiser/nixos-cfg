...
in
{
  options.nixos.modules.zsh = mkModuleOption { };
  options.darwin.modules.zsh = mkModuleOption { };
  options.homeManager.modules.zsh = mkModuleOption { };
